                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-4">
                            <p>Stay up to date</p>
                            <form className=""><div className="d-flex">
                                <input className="form-control me-2" id="mail" placeholder="Enter your email" aria-label="Enter your email" />
                                <button className="btn cta" type="button" onclick="subscribeMail()">
                                    Subscribe</button>
                            </div>
                                <span id="subMsg"></span>
                            </form>
